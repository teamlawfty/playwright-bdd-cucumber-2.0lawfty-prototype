...
export class LoginPage {
  ...
  constructor(page: Page) {
    ...
    this.invalidLoginMessage = this.page.locator(
      'p.text-red:has-text("Invalid login credentials. Please try again.")',
    )
    this.invalidEmailFormatMessage = this.page.locator(
      'div:has-text("Please include an \'@\' in the email address.")',
    )
  }
